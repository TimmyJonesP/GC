    ...
    <main className="overflow-hidden">
      ...
      <section className="h-[632px] w-full relative">
        ...
        <article className=" flex flex-col items-center justify-center h-full w-full max-w-screen-lg m-auto">
          ...
          <h4 className="text-white font-light text-[12px] px-7 mx-5 pt-7 text-center lg:px-56">
            {t("home.mission_body")}
          </h4>
        </article>
      </section>
        ...
        <div className="w-full flex flex-col lg:flex-row lg:flex-wrap items-center align-middle justify-center mt-10 lg:mt-28 max-w-screen-xl lg:mx-auto">
          {elementos.map((element, index) => (
            ...
            >
              ...
              <div className="w-[23px] h-[3px] bg-white my-7" />
              <h4 className=" text-white text-[12px] font-light m-auto justify-start lg:w-[325px] lg:h-[100px] h-[150px]">
                {element.description}
              </h4>
              <Link
                to={element.link}
                className="bg-transparent text-[14px] gradiente-gold border-golden text-golden border py-1 px-8 font-semibold mt-5 lg:m-auto "
              >
                {t("btn")}
              </Link>
            </div>
